...
A próxima etapa é corrigir esse player de música que trava em cada troca de página e talvez colocar uma seção de comentário nas postagens.

<img src="{{ '/assets/images/cat.gif' | relative_url }}" alt="cat" style="display: block; margin: 20px auto; max-width: 100%; image-rendering: pixelated;">
